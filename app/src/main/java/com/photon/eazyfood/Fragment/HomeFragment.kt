...
import com.photon.eazyfood.MenuBottomSheetFragment
import com.photon.eazyfood.R
import com.photon.eazyfood.adapter.MenuAdapter
import com.photon.eazyfood.databinding.FragmentHomeBinding
...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        //Retrive popular itemsssssssssssss
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        imageSlider.setItemClickListener(object :ItemClickListener{
            ...
            override fun onItemSelected(position: Int) {
                ...
                val itemMessage="Selected Banner ${position}"
